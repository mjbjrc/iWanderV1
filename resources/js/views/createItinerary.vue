                ...
                <form v-on:submit.prevent="getUserId">
                    <div class="form-group row justify-content-center">
                      <div class="col-md-12 mt-3">
                        ...
                        <input id="destination" type="text" class="form-control" placeholder="City" v-model="destination" name="destination" required autocomplete="email" autofocus>
                      </div>
                    </div>
                    <div class="form-group row justify-content-center">
                      <div class="col mb-3">
  ...
  methods: {
    ...
    createItinerary(){
      ...
      .then(function(response){
        ...
        app.$router.push({name: 'addtoitinerary', params: { destination: app.destination, itinerary_id: response.data.data.id} });
      })
      .catch(function(error){
        console.log(error);
      });
