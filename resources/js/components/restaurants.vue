  ...
  <div class="container mt-4">
      <div class="row justify-content-center">
        <div class="col-lg-12 mb-3">
          <h1 class="text-center">Restaurants in {{this.place}}</h1>
        </div>
        <div class="col-lg-3 col-sm-12 filter-box" style="height: 500px;">
            <div>
              <h4> Filters</h4>
              <hr/>
            </div>
        ...
        <div class="col-lg-9 col-sm-12 sort-box">
            <div>
              ...
              <div class="row">
                <div class="card mb-3" v-for="result in results" :key="result.restaurant.id">
                  <div class="row no-gutters">
                    ...
                    <div class="col-md-8">
                      <div class="card-body">
                        <h5 class="card-title"><router-link :to="{ name: 'restaurant', params: {query: result.restaurant.id} }">{{result.restaurant.name}}</router-link></h5>
